      ...
      <div class="col-12">
        ...
        >
          ...
          <template v-slot:cell(actions)="data">
            <router-link :to="{name: 'client-work-times-edit', params: { id: data.item.id }}">
  ...
  methods: {
    ...
    deleteItemOK() {
      let promise = this.$http.delete(
        this.$api("api/v1/client/worktimes/" + this.modalDelete.itemID)
      );
    ...
    getCompanies(serach) {
      ...
      let promise = this.$http.get(
        this.$api("api/v1/client/companies/list" + params)
      );
    ...
    myProvider(ctx) {
      ...
      let promise = this.$http.get(
        this.$api("api/v1/client/worktimes" + params)
      );
