  ...
  <section class="page">
    <div class="row">
      <CardProgress
        ...
        :dynomic="{name: 'client-partnear-new'}"
        type="success"
        :value="100"
        :striped="false"
        :animated="true"
      ...
      <div class="col-12">
        ...
        >
          ...
          <template v-slot:cell(actions)="data">
            <router-link :to="{name: 'client-partnear-edit', params: { id: data.item.id }}" title="ویرایش">
              <i class="fas fa-pencil-alt"></i>
            </router-link>
            <a href="#" v-on:click="deleteItem(data.item.id,data.item.company)" title="حذف">
  ...
  data() {
    return {
      fields: [
        ...
        { key: "company", label: "شرکت", sortable: true },
  ...
  methods: {
    deleteItem(itemID, itemTitle) {
      ...
      this.modalDelete.content =
        "آیا از لغو قرارداد همکاری با شرکت « " + itemTitle + " » مطمین هستید ؟";
