      ...
      <b-col cols="12">
        <div class="inner-main">
          <div class="inner-header">
            <b-row>
              <b-col cols="11">
                <span v-if="isEdit">ویرایش اعتبار « {{form.name}} »</span>
                <span v-else>اعتبار</span>
              </b-col>
              <b-col cols="1" class="text-left">
                <router-link to="/portal/credits" class="btn btn-danger w-100">بازگشت</router-link>
              </b-col>
            </b-row>
          </div>
          <b-row class="inner-body row-eq-height">
            <b-col cols="7">
              <div class="form-group row align-items-center">
                <label class="col-2 col-form-label">نام اعتبار</label>
                <div class="col-10">
                  <input
                    type="text"
      ...
      <b-col cols="12">
        <div class="inner-main">
          <b-row class="inner-body row-eq-height">
            <b-col cols="6">
              <div class="form-group row align-items-center">
                <label class="col-2 col-form-label">نوع اعتبار</label>
                <b-col cols="4" class="form-radio-datamis">
                  <input
                    id="Record"
                    type="radio"
                    ...
                    class="form-radio-input"
                  />
                  <label class="form-radio-label" for="Record">
                    <span></span>صورت وضعیت سفر
                  </label>
                </b-col>
                <b-col cols="4" class="form-radio-datamis">
                  <input
                    ...
                    class="form-radio-input"
                  />
                  <label class="form-radio-label" for="Storage">
                    <span></span>انبار داری
                  </label>
                </b-col>
              </div>
            </b-col>
            <b-col cols="6">
              <div class="form-group row align-items-center">
                <label class="col-3 col-form-label">بازه زمانی استفاده</label>
                <div class="col-8">
                  <input
                    type="number"
                    v-model.trim="form.cycle"
                    placeholder="مشخصات درست را وارد نمایید."
                    class="form-control"
                  />
                </div>
                <label class="col-1 col-form-label">روز</label>
                <small class="col-12 text-right font-size-65">نکته : برای آزاد بودن استفاده بازه زمانی را صفر در نظر بگیرید.</small>
              </div>
            </b-col>
          </b-row>
        </div>
      ...
      <b-col cols="12">
        <div class="inner-main">
          <b-row class="inner-body row-eq-height">
            <b-col cols="6">
              <div class="form-group row align-items-center">
                <label class="col-2 col-form-label">قیمت</label>
                <div class="col-9">
                  <input
                    type="number"
                ...
                <label class="col-1 col-form-label text-right">ریال</label>
              </div>
            </b-col>
            <b-col cols="6">
              <div class="form-group row align-items-center">
                <label class="col-3 col-form-label">مقدار قابل استفاده</label>
                <div class="col-8">
                  <input
                    type="number"
                ...
                <label class="col-1 col-form-label">عدد</label>
              </div>
            </b-col>
          </b-row>
        </div>
  ...
  mounted() {
    if (this.$route.params.id) {
      ...
      let promise = this.$http.get(
        this.$api("api/v1/core/credits/" + this.$route.params.id)
      );
      promise
        .then(response => {
    ...
    onSubmit(evt) {
      ...
      if (this.$route.params.id) {
        ...
        let promise = this.$http.post(
          this.$api("api/v1/core/credits/new"),
          this.form
        );
        promise
          .then(response => {
            this.$router.push(this.$route.query.redirect || "/portal/credits/");
          })
          .catch(error => {
            this.isAlert = this.dismissSecs;
            let e = error.response;
