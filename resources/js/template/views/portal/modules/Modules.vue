...
<section class="page">
  <div class="row">
    <CardProgress class="col-3 offset-9" url="/portal/modules/new" type="default" :value="100" :striped="false" :animated="true">
      <template slot="header">
        <h5 class="mb-3">تعریف ماژول جدید</h5>
      </template>
    </CardProgress><!-- -->
    ...
    <div class="col-12">
      ...
      >
        ...
        <template v-slot:cell(actions)="data">
          <router-link :to="{name: 'portal-module-edit', params: { id: data.item.id }}"><i class="fas fa-pencil-alt"></i></router-link>
...
export default {
  ...
  data() {
    return {
      fields: [
        ...
        { key: 'cycle', formatter: 'cycleType', label: 'بازه استفاده', class:"w-15", sortable: true },
  ...
  methods: {
    ...
    deleteItemOK(){
      let promise = this.$http.delete(this.$api("api/v1/core/modules/"+this.modalDelete.itemID))
    ...
    myProvider (ctx) {
      ...
      let promise = this.$http.get(this.$api("api/v1/core/modules"+params))
