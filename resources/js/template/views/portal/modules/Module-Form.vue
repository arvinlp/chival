      ...
      <b-col cols="12">
        <div class="inner-main">
          <div class="inner-header">
            <b-row>
              <b-col cols="11">
                <span v-if="isEdit">ویرایش ماژول « {{form.name}} »</span>
                <span v-else>ماژول</span>
              </b-col>
              <b-col cols="1" class="text-left">
                <router-link to="/portal/modules" class="btn btn-danger w-100">بازگشت</router-link>
              </b-col>
            </b-row>
          </div>
          <b-row class="inner-body row-eq-height">
            <b-col cols="7">
              <div class="form-group row align-items-center">
                <label class="col-2 col-form-label">نام ماژول</label>
                <div class="col-10">
                  <input
                    type="text"
      ...
      <b-col cols="12">
        <div class="inner-main">
          <b-row class="inner-body row-eq-height">
            <b-col cols="12">
              <div class="form-group row align-items-center">
                <label class="col-2 col-form-label">کد نرم افزاری ماژول</label>
                <div class="col-10">
                  <input
                    type="text"
      ...
      <b-col cols="12">
        <div class="inner-main">
          <b-row class="inner-body row-eq-height">
            ...
            <b-col cols="6">
              <div class="form-group row align-items-center">
                <label class="col-3 col-form-label">مدت استفاده</label>
                <div class="col-8">
                  <input
                    type="number"
  ...
  mounted() {
    if (this.$route.params.id) {
      ...
      let promise = this.$http.get(
        this.$api("api/v1/core/modules/" + this.$route.params.id)
      );
      promise
        .then(response => {
    ...
    onSubmit(evt) {
      ...
      if (this.$route.params.id) {
        ...
        let promise = this.$http.post(
          this.$api("api/v1/core/modules/new"),
          this.form
        );
        promise
          .then(response => {
            this.$router.push(this.$route.query.redirect || "/portal/modules/");
          })
          .catch(error => {
            this.isAlert = this.dismissSecs;
            let e = error.response;
