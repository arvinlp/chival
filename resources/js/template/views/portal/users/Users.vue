      ...
      <div class="col-12">
        ...
        >
          ...
          <template v-slot:cell(actions)="data">
            <router-link :to="{name: 'portal-user-logs', params: { id: data.item.id }}" title="تاریخچه فعالیت">
              <i class="fas fa-eye"></i>
            </router-link>
            <router-link :to="{name: 'portal-user-edit', params: { id: data.item.id }}" title="ویرایش">
  ...
  methods: {
    ...
    deleteItemOK() {
      let promise = this.$http.delete(
        this.$api("api/v1/portal/users/" + this.modalDelete.itemID)
      );
    ...
    myProvider(ctx) {
      ...
      let promise = this.$http.get(this.$api("api/v1/portal/users" + params));
