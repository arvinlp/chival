      ...
      <b-col cols="12">
        <div class="inner-main">
          <div class="inner-header">
            <b-row>
              <b-col cols="11">
                <span v-if="isEdit">ویرایش اطلاعات وسیله نقلیه « {{form.name}} »</span>
                <span v-else>افزودن اطلاعات</span>
              </b-col>
              <b-col cols="1" class="text-left">
                <router-link to="/portal/vehicle-types" class="btn btn-danger w-100">بازگشت</router-link>
              </b-col>
            </b-row>
          </div>
          <b-row class="inner-body row-eq-height">
            <b-col cols="12">
              <div class="form-group row align-items-center">
                <label class="col-1 col-form-label">عنوان</label>
                <div class="col-11">
                  <input
                    type="text"
          ...
          <b-row class="inner-body row-eq-height">
            <b-col cols="6">
              <div class="form-group row align-items-center">
                <label class="col-3 col-form-label">ظرفیت وسیله نقلیه</label>
                <div class="col-9">
                  <input
                    type="number"
                    min="0"
            ...
            <b-col cols="6">
              <div class="form-group row align-items-center">
                <label class="col-2 col-form-label">نوع ناوگان</label>
                ...
                <b-col cols="3" class="form-radio-datamis">
                  <input
                    ...
                    class="form-radio-input"
                  />
                  <label class="form-radio-label" for="MiniBus">
                    <span></span>مینی بوس
                  </label>
                </b-col>
                <b-col cols="3" class="form-radio-datamis">
                  <input
                    ...
                    class="form-radio-input"
                  />
                  <label class="form-radio-label" for="Car">
                    <span></span>سواری
                  </label>
                </b-col>
              </div>
          ...
          <b-row class="inner-body row-eq-height">
            <b-col cols="12">
              <div class="form-group row align-items-center">
                <label class="col-2 col-form-label">وضعیت دسترسی</label>
                <b-col cols="5" class="form-radio-datamis">
                  <input
                    id="Enable"
                    type="radio"
  ...
  mounted() {
    if (this.$route.params.id) {
      ...
      let promise = this.$http.get(
        this.$api("api/v1/core/vehicle-types/" + this.$route.params.id)
      );
      promise
        .then(response => {
    ...
    onSubmit(evt) {
      ...
      if (this.$route.params.id) {
        ...
        let promise = this.$http.post(
          this.$api("api/v1/core/vehicle-types/new"),
          this.form
        );
        promise
          .then(response => {
            this.$router.push(
              this.$route.query.redirect || "/portal/vehicle-types/"
            );
          })
          .catch(error => {
            this.isAlert = this.dismissSecs;
