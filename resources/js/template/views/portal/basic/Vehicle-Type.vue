...
<section class="page">
  <div class="row">
    <CardProgress class="col-3 offset-9" url="/portal/vehicle-types/new" type="default" :value="100" :striped="false" :animated="true">
    ...
    <div class="col-12">
      ...
      >
        ...
        <template v-slot:cell(actions)="data">
          <router-link :to="{name: 'portal-vehicle-type-edit', params: { id: data.item.id }}"><i class="fas fa-pencil-alt"></i></router-link>
...
export default {
  ...
  data() {
    return {
      fields: [
        ...
        { key: 'capacity', label: 'ظرفیت', sortable: true },
  ...
  methods: {
    ...
    deleteItemOK(){
      let promise = this.$http.delete(this.$api("api/v1/core/vehicle-types/"+this.modalDelete.itemID))
    ...
    myProvider (ctx) {
      ...
      let promise = this.$http.get(this.$api("api/v1/core/vehicle-types"+params))
